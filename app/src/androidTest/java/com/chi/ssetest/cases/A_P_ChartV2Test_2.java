 ...
 * 走势数据对比竞品 方法二  对应集合竞价走势 方法一      盘前走势  处理时间  时间
 *
 * @see <a href="http://d.android.com/tools/testing">Testing documentation</a>
 */
@RunWith(AndroidJUnit4.class)
@StockTestcase(StockTestcaseName.A_P_ChartV2Test_2)
public class A_P_ChartV2Test_2 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.A_P_ChartV2Test_2;
                    ...
                    try {
                        if(bidChartResponse.bidItems!=null){
                            for (BidItem item : bidChartResponse.bidItems) {
                                ...
                                uploadObj_1.put("datetime",(item.time).substring(0,12));
...
//                                Log.d("data", String.valueOf(uploadObj_1));
                                uploadObj.put((item.time).substring(0,12),uploadObj_1);
                            }
                        }
