...
@StockTestcase(StockTestcaseName.F10_STOCKNEWSTEST_1)
public class F10_StockNewsTest_1 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.F10_STOCKNEWSTEST_1;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    @BeforeClass
    public static void setup() throws Exception {
        Log.d("F10_StockNewsTest_1", "Setup");
