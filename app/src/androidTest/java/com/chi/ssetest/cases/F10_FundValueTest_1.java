...
@StockTestcase(StockTestcaseName.F10_FUNDVALUETEST_1)
public class F10_FundValueTest_1 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.F10_FUNDVALUETEST_1;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    @BeforeClass
    public static void setup() throws Exception {
        Log.d("F10_FundValueTest_1", "Setup");
    ...
    public void requestWork() throws Exception {
        Log.d("F10_FundValueTest_1", "requestWork");
                    ...
                    try {
                        if (list!=null){
                            for (int i=0;i<list.size();i++){
                                ...
                                uploadObj_1.put("ACCUNITNAV",list.get(i).get("ACCUNITNAV"));
