...
@StockTestcase(StockTestcaseName.CATESORTINGTEST_4)
public class CateSortingTest_4 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.CATESORTINGTEST_4;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    @BeforeClass
    public static void setup() throws Exception {
        Log.d("  CateSortingTest_4", "Setup");
...
//        for (int i=0;i<quoteNumbers.length;i++){
        ...
        if (quoteNumbers2.equals("null")){
            ...
            quoteCustom=new String[]{quoteNumbers2};
        }
//            CateSortingRequest request = new  CateSortingRequest();
//            request.sendFutures(quoteNumbers,quoteNumbers1,quoteCustom,new IResponseInfoCallback<CateSortingResponse>() {
//                @Override
