...
@StockTestcase(StockTestcaseName.F10_TOPLIQUIDSHAREHOLDERTEST_1)
public class F10_TopLiquidShareHolderTest_1 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.F10_TOPLIQUIDSHAREHOLDERTEST_1;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    @BeforeClass
    public static void setup() throws Exception {
        Log.d("F10_TopLiquidShareHolderTest_1", "Setup");
            ...
            request.sendV2(quoteNumbers,quoteNumbers1,new IResponseInfoCallback<TopLiquidShareHolderResponse>() {
                ...
                public void callback(TopLiquidShareHolderResponse topLiquidShareHolderResponse) {
                    ...
                    if (topLiquidShareHolderResponse.list!=null){
                        ...
                        try {
                            //把数组存储到JSON
                            uploadObj.put("items", topLiquidShareHolderResponse.list);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
