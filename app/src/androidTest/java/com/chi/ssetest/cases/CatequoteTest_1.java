...
@StockTestcase(StockTestcaseName.CATEQUOTETEST_1)
public class CatequoteTest_1 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.CATEQUOTETEST_1;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    private static final int timeout_ms = 1000000;
    @BeforeClass

    public static void setup() throws Exception {
        Log.d("  CatequoteTest_1", "Setup");
    ...
    public void requestWork() throws Exception {
        Log.d(" CatequoteTest_1", "requestWork");
        // TODO get custom args from param
        final String quoteNumbers = rule.getParam().optString("CATEGORYID");
        final String quoteNumbers1 = rule.getParam().optString("PAGEINDEX");
        final CompletableFuture result = new CompletableFuture<JSONObject>();
//        for (int i=0;i<quoteNumbers.length;i++){
            CatequoteRequest request = new  CatequoteRequest();
            request.send(quoteNumbers,quoteNumbers1, new IResponseInfoCallback<CatequoteResponse>() {
                @Override
                public void callback(CatequoteResponse catequoteResponse) {
                    try {
                        assertNotNull(catequoteResponse.list);
