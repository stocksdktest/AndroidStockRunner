...
@StockTestcase(StockTestcaseName.SEARCHTEST_2)
public class SearchTest_2 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.SEARCHTEST_2;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    private static final int timeout_ms = 1000000;
    @BeforeClass
    public static void setup() throws Exception {
        Log.d("   SearchTest_2", "Setup");
    ...
    public void requestWork() throws Exception {
        Log.d("   SearchTest_2", "requestWork");
        // TODO get custom args from param
        final String quoteNumbers = rule.getParam().optString("KEYWORD");
        final String quoteNumbers1 = rule.getParam().optString("SEARCHLIMIT");//查询条数
