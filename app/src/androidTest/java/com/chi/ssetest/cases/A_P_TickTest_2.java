 ...
 */
//分时明细对比竞品 方法二  返回全部的数据
@RunWith(AndroidJUnit4.class)
@StockTestcase(StockTestcaseName.A_P_TickTest_2)
public class A_P_TickTest_2 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.A_P_TickTest_2;
...
//                            uploadObj.put(transactionTime+"_"+(100*a+k+1),uploadObj_1);
