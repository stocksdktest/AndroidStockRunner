...
@StockTestcase(StockTestcaseName.CATESORTINGTEST_3)
public class CateSortingTest_3 {
    ...
    public void requestWork() throws Exception {
        Log.d("  CateSortingTest_3", "requestWork");
...
//                        uploadObj_1.put("upDownFlag", list.get(i).upDownFlag);//注意一下IOS android
                                ...
                                if (cateSortingResponse.addValueModel!=null){
                                    ...
                                    for (AddValueModel item : addValueModels) {
                                        ...
                                        uploadObj_2.put("code",dwnull(item.code == null ? "-" : item.code));
                                        uploadObj_2.put("date",dwnull(item.date == null ? "-" : item.date));
                                        uploadObj_2.put("time",dwnull(item.time == null ? "-" : item.time));
                                        uploadObj_2.put("ultraLargeBuyVolume",dwnull(item.ultraLargeBuyVolume == null ? "-" : item.ultraLargeBuyVolume));
                                        uploadObj_2.put("ultraLargeSellVolume",dwnull(item.ultraLargeSellVolume == null ? "-" : item.ultraLargeSellVolume));
                                        uploadObj_2.put("ultraLargeBuyAmount",dwnull(item.ultraLargeBuyAmount == null ? "-" : item.ultraLargeBuyAmount));
                                        uploadObj_2.put("ultraLargeSellAmount",dwnull(item.ultraLargeSellAmount == null ? "-" : item.ultraLargeSellAmount));
                                        uploadObj_2.put("largeBuyVolume",dwnull(item.largeBuyVolume == null ? "-" : item.largeBuyVolume));
                                        uploadObj_2.put("largeSellVolume",dwnull(item.largeSellVolume == null ? "-" : item.largeSellVolume));
                                        uploadObj_2.put("largeBuyAmount",dwnull(item.largeBuyAmount == null ? "-" : item.largeBuyAmount));
                                        uploadObj_2.put("largeSellAmount",dwnull(item.largeSellAmount == null ? "-" : item.largeSellAmount));
                                        uploadObj_2.put("mediumBuyVolume",dwnull(item.mediumBuyVolume == null ? "-" : item.mediumBuyVolume));
                                        uploadObj_2.put("mediumSellVolume",dwnull(item.mediumSellVolume == null ? "-" : item.mediumSellVolume));
                                        uploadObj_2.put("mediumBuyAmount",dwnull(item.mediumBuyAmount == null ? "-" : item.mediumBuyAmount));
                                        uploadObj_2.put("mediumSellAmount",dwnull(item.mediumSellAmount == null ? "-" : item.mediumSellAmount));
                                        uploadObj_2.put("smallBuyVolume",dwnull(item.smallBuyVolume == null ? "-" : item.smallBuyVolume));
                                        uploadObj_2.put("smallSellVolume",dwnull(item.smallSellVolume == null ? "-" : item.smallSellVolume));
                                        uploadObj_2.put("smallBuyAmount",dwnull(item.smallBuyAmount == null ? "-" : item.smallBuyAmount));
                                        uploadObj_2.put("smallSellAmount",dwnull(item.smallSellAmount == null ? "-" : item.smallSellAmount));
                                        uploadObj_2.put("ultraLargeNetInflow",dwnull(item.ultraLargeNetInflow == null ? "-" : item.ultraLargeNetInflow));
                                        uploadObj_2.put("largeNetInflow",dwnull(item.largeNetInflow == null ? "-" : item.largeNetInflow));
                                        uploadObj_2.put("netCapitalInflow",dwnull(item.netCapitalInflow == null ? "-" : item.netCapitalInflow));
                                        uploadObj_2.put("mediumNetInflow",dwnull(item.mediumNetInflow == null ? "-" : item.mediumNetInflow));
                                        uploadObj_2.put("smallNetInflow",dwnull(item.smallNetInflow == null ? "-" : item.smallNetInflow));
                                        ...
                                        uploadObj_2.put("ultraLargeDiffer",dwnull(item.ultraLargeDiffer == null ? "-" : item.ultraLargeDiffer));
                                        uploadObj_2.put("largeDiffer",dwnull(item.largeDiffer == null ? "-" : item.largeDiffer));
                                        uploadObj_2.put("mediumDiffer",dwnull(item.mediumDiffer == null ? "-" : item.mediumDiffer));
                                        uploadObj_2.put("smallDiffer",dwnull(item.smallDiffer == null ? "-" : item.smallDiffer));
                                        uploadObj_2.put("largeBuyDealCount",dwnull(item.largeBuyDealCount == null ? "-" : item.largeBuyDealCount));
                                        uploadObj_2.put("largeSellDealCount",dwnull(item.largeSellDealCount == null ? "-" : item.largeSellDealCount));
                                        uploadObj_2.put("dealCountMovingAverage",dwnull(item.dealCountMovingAverage == null ? "-" : item.dealCountMovingAverage));
                                        uploadObj_2.put("buyCount",dwnull(item.buyCount == null ? "-" : item.buyCount));
                                        uploadObj_2.put("sellCount",dwnull(item.sellCount == null ? "-" : item.sellCount));
                                        uploadObj_2.put("BBD",dwnull(item.BBD == null ? "-" : item.BBD));
                                        uploadObj_2.put("BBD5",dwnull(item.BBD5 == null ? "-" : item.BBD5));
                                        uploadObj_2.put("BBD10",dwnull(item.BBD10 == null ? "-" : item.BBD10));
                                        uploadObj_2.put("DDX",dwnull(item.DDX == null ? "-" : item.DDX));
                                        uploadObj_2.put("DDX5",dwnull(item.DDX5 == null ? "-" : item.DDX5));
                                        uploadObj_2.put("DDX10",dwnull(item.DDX10 == null ? "-" : item.DDX10));
                                        uploadObj_2.put("DDY",dwnull(item.DDY == null ? "-" : item.DDY));
                                        uploadObj_2.put("DDY5",dwnull(item.DDY5 == null ? "-" : item.DDY5));
                                        uploadObj_2.put("DDY10",dwnull(item.DDY10 == null ? "-" : item.DDY10));
                                        uploadObj_2.put("DDZ",dwnull(item.DDZ == null ? "-" : item.DDZ));
                                        uploadObj_2.put("RatioBS",dwnull(item.RatioBS == null ? "-" : item.RatioBS));
                                        ...
                                        uploadObj_2.put("fiveMinutesChangeRate",dwnull(item.fiveMinutesChangeRate == null ? "-" : item.fiveMinutesChangeRate));
                                        uploadObj_2.put("largeOrderNumB",dwnull(item.largeOrderNumB == null ? "-" : item.largeOrderNumB));
                                        uploadObj_2.put("largeOrderNumS",dwnull(item.largeOrderNumS == null ? "-" : item.largeOrderNumS));
                                        uploadObj_2.put("bigOrderNumB",dwnull(item.bigOrderNumB == null ? "-" : item.bigOrderNumB));
                                        uploadObj_2.put("bigOrderNumS",dwnull(item.bigOrderNumS == null ? "-" : item.bigOrderNumS));
                                        uploadObj_2.put("midOrderNumB",dwnull(item.midOrderNumB == null ? "-" : item.midOrderNumB));
                                        uploadObj_2.put("midOrderNumS",dwnull(item.midOrderNumS == null ? "-" : item.midOrderNumS));
                                        uploadObj_2.put("smallOrderNumB",dwnull(item.smallOrderNumB == null ? "-" : item.smallOrderNumB));
                                        uploadObj_2.put("smallOrderNumS",dwnull(item.smallOrderNumS == null ? "-" : item.smallOrderNumS));
                                        uploadObj_2.put("mainforceMoneyNetInflow5",dwnull(item.mainforceMoneyNetInflow5 == null ? "-" : item.mainforceMoneyNetInflow5));
                                        uploadObj_2.put("mainforceMoneyNetInflow10",dwnull(item.mainforceMoneyNetInflow10 == null ? "-" : item.mainforceMoneyNetInflow10));
                                        uploadObj_2.put("mainforceMoneyNetInflow20",dwnull(item.mainforceMoneyNetInflow20 == null ? "-" : item.mainforceMoneyNetInflow20));
                                        uploadObj_2.put("ratioMainforceMoneyNetInflow5",dwnull(item.ratioMainforceMoneyNetInflow5 == null ? "-" : item.ratioMainforceMoneyNetInflow5));
                                        uploadObj_2.put("ratioMainforceMoneyNetInflow10",dwnull(item.ratioMainforceMoneyNetInflow10 == null ? "-" : item.ratioMainforceMoneyNetInflow10));
                                        uploadObj_2.put("ratioMainforceMoneyNetInflow20",dwnull(item.ratioMainforceMoneyNetInflow20 == null ? "-" : item.ratioMainforceMoneyNetInflow20));
