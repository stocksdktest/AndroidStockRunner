...
//                                //3.3.0.002新增字段
//                                uploadObj_1.put("monthChangeRate", list.get(i).monthChangeRate);
//                                uploadObj_1.put("yearChangeRate", list.get(i).yearChangeRate);
//                                uploadObj_1.put("recentMonthChangeRate", list.get(i).recentMonthChangeRate);
//                                uploadObj_1.put("recentYearChangeRate", list.get(i).recentYearChangeRate);
                                //3.1.7.003新增字段
                                uploadObj_1.put("securityStatus", list.get(i).securityStatus == null ? "-" : list.get(i).securityStatus);
                                uploadObj_1.put("buyQtyUpperLimit", list.get(i).buyQtyUpperLimit == null ? "-" : list.get(i).buyQtyUpperLimit);
                                uploadObj_1.put("sellQtyUpperLimit", list.get(i).sellQtyUpperLimit == null ? "-" : list.get(i).sellQtyUpperLimit);
                                uploadObj_1.put("marketBuyQtyUpperLimit", list.get(i).marketBuyQtyUpperLimit == null ? "-" : list.get(i).marketBuyQtyUpperLimit);
                                uploadObj_1.put("marketSellQtyUpperLimit", list.get(i).marketSellQtyUpperLimit == null ? "-" : list.get(i).marketSellQtyUpperLimit);
                                uploadObj_1.put("reg", list.get(i).reg == null ? "-" : list.get(i).reg);
                                uploadObj_1.put("vie", list.get(i).vie == null ? "-" : list.get(i).vie);
                                uploadObj_1.put("mf", list.get(i).mf == null ? "-" : list.get(i).mf);
                                uploadObj_1.put("rslf", list.get(i).rslf == null ? "-" : list.get(i).rslf);
                                uploadObj_1.put("mmf", list.get(i).mmf == null ? "-" : list.get(i).mmf);
