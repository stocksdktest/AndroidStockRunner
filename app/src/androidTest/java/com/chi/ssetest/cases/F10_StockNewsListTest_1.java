...
@StockTestcase(StockTestcaseName.F10_STOCKNEWSLISTTEST_1)
public class F10_StockNewsListTest_1 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.F10_STOCKNEWSLISTTEST_1;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    @BeforeClass
    public static void setup() throws Exception {
        Log.d("F10_StockNewsListTest_1", "Setup");
    ...
    public void requestWork() throws Exception {
        Log.d("F10_StockNewsListTest_1", "requestWork");
