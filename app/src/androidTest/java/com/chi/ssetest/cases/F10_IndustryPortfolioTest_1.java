...
@StockTestcase(StockTestcaseName.F10_INDUSTRYPORTFOLIOTEST_1)
public class F10_IndustryPortfolioTest_1 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.F10_INDUSTRYPORTFOLIOTEST_1;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    private static final int timeout_ms = 1000000;
    @BeforeClass
    public static void setup() throws Exception {
        Log.d("F10_IndustryPortfolioTest_1", "Setup");
