...
@StockTestcase(StockTestcaseName.OPTIONQUOTETEST_1)
public class OptionQuoteTest_1 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.OPTIONQUOTETEST_1;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    private static final int timeout_ms = 1000000;
    @BeforeClass
    public static void setup() throws Exception {
        Log.d("OptionQuoteTest_1", "Setup");
    ...
    public void requestWork() throws Exception {
        Log.d("OptionQuoteTest_1", "requestWork");
...
//        for (int i=0;i<quoteNumbers.length;i++){
            OptionQuoteRequest request = new OptionQuoteRequest();
            request.send(quoteNumbers,quoteNumbers1,new IResponseInfoCallback<OptionQuoteResponse>() {
                @Override
                public void callback(OptionQuoteResponse optionQuoteResponse) {
                    try {
                        assertNotNull(optionQuoteResponse.list);
