...
public class OHLCV3Test_5 {
    ...
    public void requestWork() throws Exception {
        ...
        final String []Numbers = rule.getParam().optString("Numbers", "").split(",");
//        OHLChartType
        ...
        for (int i=0;i<CODES.length;i++){
            ...
            quoteDetailRequest.send(CODES[i], new IResponseInfoCallback() {
                ...
                public void callback(Response response) {
                    ...
                    request.send(quoteItem,Types[b],Integer.parseInt(FqTypes[b]),Dates[b],Integer.parseInt(Numbers[b]), new IResponseCallback() {
                        @Override
                        public void callback(Response response) {
