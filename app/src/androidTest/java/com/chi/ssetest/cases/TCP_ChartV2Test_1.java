...
@StockTestcase(StockTestcaseName.TCP_CHARTV2TEST_1)
public class TCP_ChartV2Test_1 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.TCP_CHARTV2TEST_1;
