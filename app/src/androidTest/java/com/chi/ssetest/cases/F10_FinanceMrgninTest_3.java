...
@StockTestcase(StockTestcaseName.F10_FINANCEMRGNINTEST_3)
public class F10_FinanceMrgninTest_3 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.F10_FINANCEMRGNINTEST_3;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    private static final int timeout_ms = 1000000;
    @BeforeClass
    public static void setup() throws Exception {
        Log.d("F10_FinanceMrgninTest_3", "Setup");
...
//        for (int i=0;i<quoteNumbers.length;i++){
        ...
        if (quoteNumbers3.equals("null")){
            ...
            request.sendStock(quoteNumbers,src,quoteNumbers2,part,new IResponseInfoCallback<F10V2Response>() {
                @Override
