...
@StockTestcase(StockTestcaseName.SEARCHTEST_3)
public class SearchTest_3 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.SEARCHTEST_3;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    @BeforeClass
    public static void setup() throws Exception {
        Log.d("   SearchTest_3", "Setup");
    ...
    public void requestWork() throws Exception {
        Log.d("   SearchTest_3", "requestWork");
