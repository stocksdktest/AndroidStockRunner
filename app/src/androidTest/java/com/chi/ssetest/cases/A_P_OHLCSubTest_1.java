                        ...
                        if(list!=null){
                            for (int i=0;i<list.size();i++) {
                                ...
                                if(list.get(i).increaseProportion == null){
                                    ...
                                    uploadObj_1.put("bonusProportion", list.get(i).bonusProportion == null ? "0.000" : String.format("%.3f",(Float.parseFloat(list.get(i).bonusProportion)+Float.parseFloat(list.get(i).increaseProportion))));
                                }
