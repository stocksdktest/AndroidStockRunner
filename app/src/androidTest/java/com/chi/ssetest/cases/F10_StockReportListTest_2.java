...
@StockTestcase(StockTestcaseName.F10_STOCKREPORTLISTTEST_2)
public class F10_StockReportListTest_2 {
    private static final StockTestcaseName testcaseName = StockTestcaseName.F10_STOCKREPORTLISTTEST_2;
    private static SetupConfig.TestcaseConfig testcaseConfig;
    @BeforeClass
    public static void setup() throws Exception {
        Log.d("F10_StockReportListTest_2", "Setup");
    ...
    public void requestWork() throws Exception {
        Log.d("F10_StockReportListTest_2", "requestWork");
...
//        for (int i=0;i<quoteNumbers.length;i++){
        ...
        if(quoteNumbers2.equals("null")){
            ...
            request.sendV2(quoteNumbers,Integer.parseInt(quoteNumbers1),newsID,quoteNumbers3,Integer.parseInt(quoteNumbers4),new IResponseInfoCallback<StockReportListResponse>() {
                @Override
                public void callback(StockReportListResponse stockReportListResponse) {
                    ...
                    if (stockReportListResponse.list!=null){
                        ...
                        try {
                            uploadObj.put("items",stockReportListResponse.list);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
