...
public enum StockTestcaseName {
    QUOTE_REQUEST_EXAMPLE("TESTCASE_0"),//测试例子  ABQUOTETEST_1
    ABQUOTELISTTEST_1("ABQUOTELIST_1"),//AB股列表接口
    ABQUOTETEST_1("ABQUOTE_1"),//AB股联动接口
//    ADDVALUETEST_1("ADDVALUE_1"),//增值指标（废弃）
//    ADDVALUETEST_2("ADDVALUE_2"),//增值指标（废弃）
    ...
    CONVERTIBLEDEBTLISTTEST_1("CONVERTIBLEDEBTLIST_1"),//可转债行情列表
    ...
    MOREPRICETEST_3("MOREPRICE_3"),//分价
...
//    F10
    ...
    F10V2CLSTEST_1("F10V2CLSTEST_1"),//财联社接口
