...
public enum StockTestcaseName {
    ...
    CATESORTINGTEST_4("CATESORTING_4"),//排序接口
    ...
    OHLCTEST_1("OHLCTEST_1"),//K线数据
    OHLCTEST_2("OHLCTEST_2"),//K线数据
    ...
    PLATEINDEXQUOTETEST_1("PLATEINDEXQUOTE_1"),//板块指数
    PLATEINDEXQUOTETEST_2("PLATEINDEXQUOTE_2"),//板块指数
    QUOTEDETAILTEST_1("QUOTEDETAIL_1"),//行情快照
    QUOTEDETAILTEST_2("QUOTEDETAIL_2"),//行情快照
    QUOTEDETAILTEST_3("QUOTEDETAIL_3"),//行情快照
